function [fault_MLE,Precision_MLE,Recall_MLE]=MLE(DATA,Gtruth)
...
p1=0.001; %0.1; This value 0.001 is put by Shikhar
k1=1/sqrt(p1);
...
ODV_1U=mean1+0.5*k1*variance1; % this 0.5 is put by Shikhar
...
% p2=0.0001;
p2=0.1;%0.05; 0.1 is change by Shikhar
k2=1/sqrt(p2);
...
Precision_MLE=0;
 ...
 if result_Chebyshev(1,1)~=0 && result_DBSCAN(1,1)~=0 && result_Regression(1,1)~=0
pred1=predict(:,2:4);
